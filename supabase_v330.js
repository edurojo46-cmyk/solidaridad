    ...
    subscribeToMessages(room, callback) {
        ...
        return channel
            .on('postgres_changes', {
                ...
                schema: 'public',
                table: 'messages'
                // Filtramos por la conversaciÃ³n para no recibir basura de otros
                // Nota: Supabase Realtime soporta filtros simples. 
                // Pero como el room ya es especÃ­fico, el Broadcast llegarÃ¡ bien.
                // El postgres_changes lo dejamos sin filtro o con un filtro de "uno de los dos"
            }, function(payload) {
                var m = payload.new;
                if (!m) return;
                // Validamos que el mensaje pertenezca a esta conversaciÃ³n
